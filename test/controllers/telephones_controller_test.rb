...
class TelephonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telephone" do
    assert_difference('Telephone.count') do
      post telephones_url, params: { telephone: { Telephone_id: @telephone.Telephone_id, number: @telephone.number } }
    end
  ...
  test "should update telephone" do
    patch telephone_url(@telephone), params: { telephone: { Telephone_id: @telephone.Telephone_id, number: @telephone.number } }
